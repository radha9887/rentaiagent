...
cd /home/openclaw/workspace/rentaiagent
pkill -f "uvicorn main:app" 2>/dev/null
sleep 1
nohup python3 -m uvicorn main:app --host 0.0.0.0 --port 8100 >> /tmp/raa-api.log 2>&1 &
echo "API PID=$!"

# Start Dashboard
pkill -f "next-server" 2>/dev/null  
sleep 1
cd /home/openclaw/workspace/rentaiagent/dashboard
